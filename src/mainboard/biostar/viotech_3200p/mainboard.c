 ...
 *
 * Copyright (C) 2018 Ludwig Jaffe <ludwig.jaffe@gmail.com>
 *
...
/*
 * Inspired from different via C7 boards
 */
...
VIA C7-D (cpu)
VX900 (northbridge)
ite IT8728F (super-io)
w25q80bv (8MBIT=1MBYTE dual SPI-flash)
rtl8103 (fast ethernet, pcie -this really sucks, why not gigabit ethernet here)
VT1708S	(sound)
IDT_9UM709B (special programable clock generator for via vx900-overclock/underclock )
uP6120 (dcdc-controller?)
...
struct chip_operations mainboard_ops = {
	CHIP_NAME("Biostar Viotech 3200+ Mainboard")
